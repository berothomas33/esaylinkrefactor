...
/** 
 * DAO for table "dpas_aid".
*/
public class DpasAidBeanDao extends AbstractDao<DpasAidBean, Long> {

    public static final String TABLENAME = "dpas_aid";

    /**
     * Properties of entity DpasAidBean.<br/>
     * Can be used for QueryBuilder and for referencing column names.
     */
    public static class Properties {
        public final static Property Id = new Property(0, Long.class, "id", true, "dpas_id");
        ...
        public final static Property ExceptFileFlag = new Property(17, byte.class, "exceptFileFlag", false, "EXCEPT_FILE_FLAG");
        public final static Property Ttq = new Property(18, String.class, "ttq", false, "TTQ");
    }


    public DpasAidBeanDao(DaoConfig config) {
        super(config);
    }
    
    public DpasAidBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"dpas_aid\" (" + //
                "\"dpas_id\" INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: id
                ...
                "\"EXCEPT_FILE_FLAG\" INTEGER NOT NULL ," + // 17: exceptFileFlag
                "\"TTQ\" TEXT);"); // 18: ttq
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"dpas_aid\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DpasAidBean entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(18, entity.getExceptFileFlag());
 
        String ttq = entity.getTtq();
        if (ttq != null) {
            stmt.bindString(19, ttq);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, DpasAidBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public DpasAidBean readEntity(Cursor cursor, int offset) {
        DpasAidBean entity = new DpasAidBean( //
            ...
            (byte) cursor.getShort(offset + 17), // exceptFileFlag
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18) // ttq
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, DpasAidBean entity, int offset) {
        ...
        entity.setExceptFileFlag((byte) cursor.getShort(offset + 17));
        entity.setTtq(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(DpasAidBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DpasAidBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DpasAidBean entity) {
